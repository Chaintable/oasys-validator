...
require (
	...
	github.com/Chaintable/pipeline v0.0.69-0.20260814032238-1e1f9a8d1d11
...
replace (
	...
	// Pin etcd to v3.5.x — v3.6.0 introduces versionpb which registers protobuf
	// extension 50001 on FieldOptions, conflicting with other packages. Pulled
	// to v3.6.0 only transitively via certificate-transparency-go (which doesn't
	// actually use etcd in the code paths we link).
	go.etcd.io/etcd/api/v3 => go.etcd.io/etcd/api/v3 v3.5.30
	go.etcd.io/etcd/client/pkg/v3 => go.etcd.io/etcd/client/pkg/v3 v3.5.30
	go.etcd.io/etcd/client/v3 => go.etcd.io/etcd/client/v3 v3.5.30
)
